  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 bg-[#050505] border-r border-[#1a1a1a] flex flex-col p-6 z-50">
      ...
      <div className="mt-6 flex items-center gap-3 px-2">
        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#00FF66] to-[#1DB954] shadow-[0_0_10px_rgba(0,255,102,0.3)]"></div>
        <div className="text-sm">
          <p className="text-white font-medium">User Name</p>
          <p className="text-xs text-gray-500">Lvl. 5 Challenger</p>
        </div>
      </div>
    </div>
  );
